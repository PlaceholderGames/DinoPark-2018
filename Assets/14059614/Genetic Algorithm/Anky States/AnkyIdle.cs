...
using System;
using FSM;
public class AnkyIdle : State<AnkyAI>
{
    int move;
    Vector3 randTarget;
    float moveDuration;
    ...
    public override void EnterState(AnkyAI owner)
    {
    }
    public override void ExitState(AnkyAI owner)
    {

    }
    public override void UpdateState(AnkyAI owner)
    {
